    ...
    container.innerHTML = `
      ...
      <div class="tenant-form-card">
        ...
        <div class="tenant-signature-section" style="margin-top: 1.5rem; margin-bottom: 1rem;">
          <label class="form-label" style="font-weight: 700; color: var(--text-main); margin-bottom: 6px; display: block;">Assinatura Manuscrita (Desenhe com o dedo ou mouse)</label>
          <div class="signature-pad-wrap" style="position: relative; border: 2px dashed var(--border-focus); border-radius: 12px; background: #FFFFFF; overflow: hidden; touch-action: none;">
            <canvas id="signature-canvas" height="150" style="width: 100%; display: block; cursor: crosshair;"></canvas>
            <div id="signature-placeholder" style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; gap: 6px; color: #64748B; pointer-events: none; font-size: 0.9rem; font-weight: 500;">
        ...
        <div class="tenant-selfie-section" style="margin-top: 1.5rem; margin-bottom: 1.5rem;">
          <label class="form-label" style="font-weight: 700; color: var(--text-main); margin-bottom: 6px; display: block;">Validação Facial (Selfie com Documento)</label>
          <div class="selfie-card-wrap" style="border: 2px dashed var(--border-focus); border-radius: 12px; background: var(--card-bg); padding: 1.25rem; text-align: center;">
            <div id="selfie-preview-container" style="display: none; margin-bottom: 10px;">
              <img id="selfie-preview-img" style="max-height: 180px; max-width: 100%; border-radius: 8px; border: 1px solid var(--border-light);" alt="Sua Selfie">
            </div>
            ...
            <p id="selfie-hint" style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 12px; line-height: 1.4;">Tire uma foto sua segurando o seu documento para validar sua assinatura no contrato.</p>
